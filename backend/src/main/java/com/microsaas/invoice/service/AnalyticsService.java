...
public class AnalyticsService {
        ...
        public DashboardStatsDTO getDashboardStats(String tenantId) {
                ...
                BigDecimal pendingAmount = invoiceRepository.findByTenantIdAndStatus(tenantId, InvoiceStatus.SENT)
                                .stream()
                                .map(invoice -> invoice.getGrandTotal())
                                .reduce(BigDecimal.ZERO, BigDecimal::add);
